...
class OnboardView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        iconView.constraints(top: nil, leading: nil, bottom: titleLabel.topAnchor, trailing: nil, padding: .init(top: 0, left: 0, bottom: 20, right: 0), size: .init(width: 100, height: 100))
