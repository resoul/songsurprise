...
class PlayerController: UIViewController {
    ...
    private lazy var submitButton: GradientButton = {
        ...
        button.setTitle("Select track", for: .normal)
    ...
    init(index: Int, tracks: [TrackModel]) {
        self.index = index
        self.tracks = tracks
    ...
    override func viewDidLoad() {
        ...
        view.addSubviews(coverAlbum, titleLabel, detailsLabel, durationSlider)
        view.addSubviews(durationView, playPauseButton, nextButton, backButton, submitButton)
    ...
    func configurePlayer() {
        ...
        do {
            let endpoint = try supabase.storage.from("audio").getPublicURL(path: song.endpoint)
