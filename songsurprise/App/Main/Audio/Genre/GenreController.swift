...
class GenreController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        navigationItem.title = String(localized: "genre.chose")
        ...
        Task {
            genres = try await supabase.from("genres").select().execute().value
...
extension GenreController: CollectionViewProvider {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        navigationController?.pushViewController(TrackController(genre: genres[indexPath.row]), animated: true)
    }
}
